...
import {renameContext} from "../../../redux/actions/context";

RenameContextAction.propTypes = {
    contextId: PropTypes.string.isRequired
}

export default function RenameContextAction({contextId}) {
    ...
    function onSubmit(data) {
        dispatch(renameContext(contextId, data.name));
        closeModal();
    }
    ...
    return (
        <>
            ...
            <Modal
                ...
                <h2 style={{marginBottom: 0}}>Rename context</h2>
                <p>
                    Click the Rename button to rename the following context:<br/>
                    <i>{name}</i>
                </p>
